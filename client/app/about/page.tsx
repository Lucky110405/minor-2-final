                ...
                <div className="grid md:grid-cols-2 gap-12">
                  <div className="group text-center">
                    <div className="relative w-56 h-56 mx-auto mb-6">
                      ...
                      <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-2xl group-hover:scale-105 transition-transform duration-300">
                        <Image src="/images/lucky.jpg" alt="Lucky" fill className="object-cover" />
                      </div>
                    </div>
                    <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Lucky</h3>
                  ...
                  <div className="group text-center">
                    <div className="relative w-56 h-56 mx-auto mb-6">
                      ...
                      <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-2xl group-hover:scale-105 transition-transform duration-300">
                        <Image src="/images/tanishk.jpg" alt="Tanishk" fill className="object-cover" />
                      </div>
                    </div>
                    <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Tanishk</h3>
